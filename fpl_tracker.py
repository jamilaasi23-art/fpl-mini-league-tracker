...
<style>
    ...
    .clickable-row {display:flex;align-items:center;padding:6px 8px;margin:2px 0;border-radius:6px;border-left:3px solid #30363D;font-size:11.5px;cursor:pointer;transition:0.2s;}
...
for player in standings:
    ...
    r = int(233 + (61 - 233) * ratio)
    g = int(0 + (25 - 0) * ratio)
    b = int(82 + (91 - 82) * ratio)
